...
const socialLinks = [
  { name: "Twitter", icon: FaTwitter, url: "https://twitter.com/anthem250" },
  { name: "Facebook", icon: FaFacebook, url: "https://facebook.com/anthem250" },
  { name: "Instagram", icon: FaInstagram, url: "https://www.instagram.com/anthem250th" },
  { name: "YouTube", icon: FaYoutube, url: "https://youtube.com/@anthem250" },
  { name: "Telegram", icon: FaTelegram, url: "https://t.me/anthem250" },
  ...
  { name: "TikTok", icon: FaTiktok, url: "https://www.tiktok.com/@anthem250th" },
  ...
  { name: "Pinterest", icon: FaPinterest, url: "https://www.pinterest.com/anthem250/" },
  { name: "Truth Social", icon: FaGlobe, url: "https://truthsocial.com/@Anthem250" },
  { name: "Gettr", icon: FaGlobe, url: "https://gettr.com/user/anthem250" },
];

export default function SocialMediaBar() {
  return (
    <div className="bg-patriot-navy border-b border-patriot-gold/20 py-3">
